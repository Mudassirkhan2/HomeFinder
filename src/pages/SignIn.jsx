        ...
        >
          ...
          <form onSubmit={onSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between text-[13px]">
              <label className="flex items-center gap-2 text-content-secondary dark:text-content-muted cursor-pointer select-none">
                <input
                  type="checkbox"
                  checked={remember}
              ...
              <Link to="/forgot-password" className="text-primary hover:text-primary-hover font-semibold transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-7 text-center text-sm text-content-secondary dark:text-content-muted">
            ...
            <Link to="/sign-up" className="text-primary font-bold hover:text-primary-hover transition-colors">
              Create one →
            </Link>
          </p>
        </motion.div>
